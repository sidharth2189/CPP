/*
    In addition to static member variables, C++ supports static member functions (or "methods"). 
    ...
    One corollary to this is that we can method invoke a static member function without
    ever creating an instance of the class.
*/
