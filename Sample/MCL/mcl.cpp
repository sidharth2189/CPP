...
int main()
{
    ...
    // Note: Since you are working with random values, this program will output 
    // different numbers each time you run it!
    */
   ...
   //Practice Interfacing with Robot Class
    ...
    double w[n];
    for (int i = 0; i < n; i++) {
        // w[i] = myrobot.measurement_prob(z) - p[i].measurement_prob(z);
